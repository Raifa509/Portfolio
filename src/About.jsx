...
function About() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 md:pt-20 px-6 md:px-20 text-white flex flex-col items-center">
      <div className="grid md:grid-cols-2 bg-gray-900/60 backdrop-blur-lg rounded-2xl shadow-[0_0_25px_rgba(56,189,248,0.25)] md:mx-32 p-10 gap-10 border border-cyan-500/10">

        <div className="flex items-center justify-center">
          <div className="relative h-72 w-72 md:h-80 md:w-80 border-2 border-cyan-300 rounded-2xl shadow-[0_0_20px_#22d3ee]">
            <div className="absolute h-72 w-72 md:h-80 md:w-80 left-5 bottom-5 overflow-hidden rounded-2xl">
              <img
                src="/Raifa.jpg"
                alt="Raifa"
        ...
        <div className="flex flex-col justify-center text-gray-300 leading-relaxed">
